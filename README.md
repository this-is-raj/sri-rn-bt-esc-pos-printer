...
3. (React Native 0.59 and lower) Add _`import cn.sri.bluetooth.RNBluetoothEscposPrinterPackage;`_ and _`new RNBluetoothEscposPrinterPackage()`_ in your _`MainApplication.java`_ :
